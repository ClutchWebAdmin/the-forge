...
export default function VaultPhotoSection() {
  return (
    <div className="flex-1 flex-col items-center justify-between w-full lg:w-2/5">
      <div className="grid grid-cols-2 items-center gap-5 md:gap-10 bg-vaultPurple-light w-full h-full p-5 md:p-10">
