...
export default function OverviewSection() {
  return (
    <section
      id="overview"
      className="bg-gray-100 p-5 lg:p-10 flex flex-col gap-4 lg:gap-8 justify-center items-center"
    >
      <div className="flex flex-col gap-2 lg:gap-4 text-center">
        <h1
          className={`${aoboshiOne.className} tracking-wide font-extrabold text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-forgeBrown`}
        >
