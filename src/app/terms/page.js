...
export default async function TermsPage() {
  const termsArray = [
    ...
    },
    {
      ...
      paragraph:
        "The Site and its original content, features, and functionality are owned by The Forge and are protected by international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.",
    },
    {
    ...
    },
    {
      ...
      paragraph:
        "In no event shall The Forge be liable for any indirect, incidental, special, consequential, or punitive damages, arising out of or in connection with your use of the Site.",
    },
    {
      heading: "Indemnification",
      paragraph:
        "You agree to indemnify and hold harmless The Forge and its officers, directors, employees, and agents, from and against any claims, liabilities, damages, losses, and expenses, including reasonable legal fees, arising out of or in any way connected with your use of the Site or violation of these Terms.",
    },
    {
      ...
      >
        ...
        >
          <div className="flex flex-col gap-3">
            ...
            <p>
              These Terms of Service ('Terms') govern your use of the The Forge ('we', 'us', or 'our') website forgesalem.com
